...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    baseUrl: localConfig.deployLocally
      ? localConfig.baseUrl_local
      : localConfig.baseUrl,
    roleSandboxUrl: localConfig.deployLocally
      ? localConfig.roleSandboxUrl_local
      : localConfig.roleSandboxUrl,
    yjsConnectorUrl: localConfig.deployLocally
      ? localConfig.yjsConnectorUrl_local
      : localConfig.yjsConnectorUrl,
    ...
    copy: {
      options: {
        ...
        processContentExclude: [
          "**/*.{png,gif,jpg,svg,otf,woff,woff2,ttf}",
          "**/lodash.js",
        ],
      },
      lib: {
        files: [
          {
            src: "<%= nodemodules %>/@rwth-acis/iwc/iwc.js",
            dest: "<%= distdir %>/js/lib/vendor/iwc.js",
          },
          {
            src: "<%= nodemodules %>/jquery/dist/jquery.js",
          ...
          {
            cwd: "<%= nodemodules %>/jquery-ui/themes/base",
            expand: true,
            src: ["images/*"],
            dest: "<%= distdir %>/css/vendor/",
          },
          {
            src: "<%= nodemodules %>/jsPlumb/dist/js/jquery.jsPlumb-1.5.*.js",
            dest: "<%= distdir %>/js/lib/vendor/jquery.jsPlumb.js",
          },
          {
            src: "<%= nodemodules %>/jquery-contextmenu/dist/jquery.contextMenu.js",
            dest: "<%= distdir %>/js/lib/vendor/jquery.contextMenu.js",
          },
          {
            src: "<%= nodemodules %>/jquery-contextmenu/dist/jquery.contextMenu.css",
          ...
          {
            src: "<%= nodemodules %>/lodash/dist/lodash.js",
            dest: "<%= distdir %>/js/lib/vendor/lodash.js",
          },
          {
            src: "<%= nodemodules %>/jszip/dist/jszip.js",
          ...
          {
            src: "<%= nodemodules %>/mocha/mocha.js",
            dest: "<%= distdir %>/js/lib/vendor/test/mocha.js",
          },
          {
          ...
          {
            src: "<%= nodemodules %>/JSCheck/jscheck.js",
            dest: "<%= distdir %>/js/lib/vendor/test/jscheck.js",
          },
          {
            src: "plugin/syncmeta-plugin.js",
            dest: "<%= distdir %>/plugin/syncmeta-plugin.js",
          },
        ],
      },
      main: {
    ...
    buildwidgets: {
      ...
      bot_widget: {
        options: {
          data: {
            ...
            bodyPartial: "_bot_widget.tpl",
          },
        },
        files: {
          "html/bot.xml": ["<%= srcdir %>/widgets/widget.xml.tpl"],
        },
      },
      ...
      bot_widget_html: {
        ...
        files: {
          "html/bot.html": ["<%= srcdir %>/widgets/widget.html.tpl"],
        },
      },
    ...
    jsdoc: {
      canvas: {
        src: ["main_widget.js", "<%= srcdir %>/js/canvas_widget", "README.md"],
        options: {
